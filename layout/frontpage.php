...
if (isloggedin() && !isguestuser()) {
    ...
    echo $OUTPUT->render_from_template('theme_abierta/frontpage', $templatecontext);
} else {
    ...
    echo $OUTPUT->render_from_template('theme_abierta/frontpage_guest', $templatecontext);
}
