...
class theme_abierta_core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function render_lang_menu() {
        ...
        if ($haslangmenu) {
            ...
            if (isset($context)) {
                return $this->render_from_template('theme_abierta/lang_menu', $context);
            }
        }
    }
    ...
    public function get_pix_image_url_base() {
        ...
        return $CFG->wwwroot . "/theme/abierta/pix";
    }
    ...
    public function user_menu($user = null, $withlinks = null) {
        ...
        if (!isloggedin()) {
            $returnstr = '';
            if (!$loginpage) {
                $returnstr .= ' <a href="' . $loginurl . '" class="in">' . get_string('login') . '</a>';
                $returnstr .= ' <a href="' . $CFG->wwwroot . '/login/signup.php" class="signup">' .
                                    get_string('signup', 'theme_abierta') . '</a>';
            }
    ...
    public function search_box($identifier = false) {
        ...
        return html_writer::tag('div',
                                ...
                                array('class' => 'abierta-search-input nav-link', 'id' => $identifier));
    }
